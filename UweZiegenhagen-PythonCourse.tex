...
%
%\begin{itemize}
%\item \lstinline[language={Python}]{input()}, um von der Konsole zu lesen
%\item Wchtig: \lstinline[language={Python}]{input()} liest nur Strings, numerische Werte müssen umgewandelt werden 
%\item \lstinline[language={Python}]{print()} zur Ausgabe
%\item Verschiedene Möglichkeiten, die Ausgabe zu formatieren (Siehe Kapitel \enquote{String-Bearbeitung})
%\end{itemize}
%\end{frame}
...
%\lstinputlisting[language={Python},caption={while-04.py \ta{Codes/while-04.py}}]{Codes/while-04.py}
...
\end{lstlisting} % # http://book.pythontips.com/en/latest/for_-_else.html
